...
export function CloudSolutionsPage({ onNavigate }: CloudSolutionsPageProps) {
  const features = [
    {
      title: "AWS",
      items: ["EC2", "S3 Storage", "Lambda", "CloudFront"]
    },
    {
      title: "Azure",
      items: ["Azure VMs", "Azure Storage", "Azure Functions", "Azure CDN"]
    },
    {
      title: "Google Cloud",
      items: ["Compute Engine", "Cloud Storage", "App Engine", "BigQuery"]
    },
    {
      title: "Migração Cloud",
      items: ["Planejamento", "Execução", "Monitoramento", "Otimização"]
    }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Soluções em nuvem escaláveis e seguras para sua empresa
            </p>
          </motion.div>
        </div>
      </section>
